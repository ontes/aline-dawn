...
fn includeDawn(lib: *std.build.LibExeObjStep, options: Options) void {
    ...
    lib.addIncludePath(root_dir ++ "dawn/src");
...
fn includeSprvtools(lib: *std.build.LibExeObjStep) void {
    lib.addIncludePath(root_dir ++ "spirv-tools");
    lib.addIncludePath(root_dir ++ "spirv-tools-gen");
    lib.addIncludePath(root_dir ++ "spirv-tools/include");
    lib.addIncludePath(root_dir ++ "spirv-headers/include");
}

fn includeAbsl(lib: *std.build.LibExeObjStep) void {
    lib.addIncludePath(root_dir ++ "abseil-cpp");
}
...
fn addLibDawnCommon(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode, options: Options) *std.build.LibExeObjStep {
    ...
    includeDawn(lib, options);

    const src_dir = root_dir ++ "dawn/src/dawn/common/";
    const gen_dir = root_dir ++ "dawn-gen/src/dawn/common/";
...
fn addLibDawnPlatform(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode, options: Options) *std.build.LibExeObjStep {
    ...
    const src_dir = root_dir ++ "dawn/src/dawn/platform/";
...
fn addLibDawnNative(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode, options: Options) *std.build.LibExeObjStep {
    ...
    const src_dir = root_dir ++ "dawn/src/dawn/native/";
    const gen_dir = root_dir ++ "dawn-gen/src/dawn/native/";
    ...
    if (options.enable_opengl or options.enable_opengles) {
        lib.addIncludePath(root_dir ++ "dawn/third_party/khronos");
        lib.addCSourceFiles(&.{
...
fn addLibTint(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode, options: Options) *std.build.LibExeObjStep {
    ...
    const src_dir = root_dir ++ "dawn/src/tint/";
...
fn addLibSpvtools(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode) *std.build.LibExeObjStep {
    ...
    const src_dir = root_dir ++ "spirv-tools/source/";
...
fn addLibAbslStrings(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode) *std.build.LibExeObjStep {
    ...
    const src_dir = root_dir ++ "abseil-cpp/absl/";
...
fn getOsTag(target: std.zig.CrossTarget) std.Target.Os.Tag {
    return target.os_tag orelse @import("builtin").target.os.tag;
}
